...
from Controller.plugins.simulated_annealing import SimulatedAnnealingController
...
def main():
    ...
    algos_metadata = {
        ...
        SimulatedAnnealingController.ALGO_NAME: {
            "subtitle": SimulatedAnnealingController.SUBTITLE,
            "theme": SimulatedAnnealingController.THEME
        },
    }
    ...
    controllers = {
        ...
        "Simulated Annealing": SimulatedAnnealingController(model),
    }
